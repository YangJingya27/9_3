...
#SBATCH --partition=cpuQ                # fatQ-80cores,1536GB; cpuQ-48cores,192GB
...
/public/home/hpc202111105/.conda/envs/py3.8/bin/python  gen_samples_for_image_reconstruct.py --bin_num_total ${b} --bin_num ${bi} --parall_nodes ${parall_nodes}
